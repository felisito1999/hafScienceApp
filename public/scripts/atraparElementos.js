...
function seleccionarelemento()
{
	...
	{ 	ctx.clearRect(0,0,700,600)
		...
		console.log("entre op1"+puntosjuegosacumuldos+valorpositivosodium+valorpositivotitaium+monstersCaught+vartempo+totalTime)
							...
							monsterImage.src = "sodium.png" ;
							monsterImage2.src = "titanium.png" ;						
							monsterImage4.src = "potassium.png" ;
							monsterImage5.src="lithium.png";
							monsterImage6.src="magnesium.png";
							monsterImage7.src="calcium.png";
							monsterImage8.src="be.png";
							monsterImage9.src="sc.png";
	...
	else if (eleccion=='op2')
	{
		...
		//
		monsterImage.src = "lithium.png" ;
		monsterImage2.src = "potassium.png" ;
		monsterImage7.src="calcium.png";
		monsterImage8.src="be.png";
		monsterImage6.src="magnesium.png";
		...
		monsterImage4.src = "carbon.png" ;
		monsterImage5.src="hydrogen.png";

		

		//metaloide
		monsterImage9.src="boro.png";
