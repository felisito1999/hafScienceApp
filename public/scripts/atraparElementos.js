...
function seleccionarelemento() {
  ...
  if (eleccion == 'op1') {
    ...
    parrafoh4.textContent =
      'Tiene 60 segundo para elegir los elementos: Sodio, Titanio y Escandio ';
    totalTime = 60;
    vartempo = 0;
    monstersCaught = 0;
    ...
    console.log(
      'entre op1' +
        puntosjuegosacumuldos +
        valorpositivosodium +
        valorpositivotitaium +
        monstersCaught +
        vartempo +
        totalTime
    );
    ...
    heroImage.src =
      'https://raw.githubusercontent.com/lostdecade/simple_canvas_game/master/images/hero.png';
    ...
    function colision() {
      ...
      //titanium
        ...
        hero.x <= monsterposi.x + 35 &&
        monsterposi.x <= hero.x + 35 &&
        hero.y <= monsterposi.y + 35 &&
        monsterposi.y <= hero.y + 35
      ) {
    ...
    ctx.clearRect(0, 0, 700, 600);
    parrafoh4.textContent =
      "Tiene 40 segundos para elegir los elementos de los grupo 'No metales Poliatomico y Metaloide' ";
    totalTime = 40;
    vartempo = 0;
    monstersCaught = 0;
    console.log(vartempo);
    ...
    ctx.clearRect(0, 0, 700, 600);
    parrafoh4.textContent =
      "Tiene 20 segundos para elegir los elementos que masa atómica son '47.867, 44.955910 y 58.6934' ";
    totalTime = 20;
    vartempo = 0;
    monstersCaught = 0;
    console.log(vartempo);
    ...
    //
    monsterImage.src = 'cromo.png';
    monsterImage2.src = 'cobre.png';
    monsterImage7.src = 'mn.png';
    monsterImage8.src = 'hierro.png';
    monsterImage6.src = 'metal.png';

    monsterImage4.src = 'niquel.png';
    monsterImage5.src = 'sc.png';

    monsterImage9.src = 'titanium.png';
...
function updateClock() {
  ...
  if (totalTime < 1 && puntosjuegosacumuldos < 3) {
    ...
    parrafo.textContent =
      'Se acabó el tiempo. Obtuvo ' + monstersCaught + ' ' + 'Puntos';

    mostrarcuadroresultado();
    mostrar();
    seleccion.value = '0';
    ganadoroperdedor.textContent =
      '¡¡Casi lo logras!!, puedes lograrlo en el proximo intento. Vamos, animate!';
    vartempo = 1;
  }
  ...
  if (totalTime < 1 && puntosjuegosacumuldos >= 3) {
    ...
    if (monstersCaught < 1 && puntosjuegosacumuldos >= 3) {
      ...
      seleccion.value = '0';
      ganadoroperdedor.textContent =
        '¡¡Ohh noo!!, Seleccionaste los elementos correctos. Pero, tu puntuación no es buena. Vamos, intentalo de nuevo';
      vartempo = 1;
    }
    if (puntosjuegosacumuldos >= 3) {
      ...
      mostrar();
      seleccion.value = '0';
      ganadoroperdedor.textContent = '¡¡Ganaste!!, Estamos orgulloso de tí!';
      vartempo = 1;
    }
    if (monstersCaught <= -3) {
      ...
      seleccion.value = '0';
      ganadoroperdedor.textContent =
        '¡¡Uff!!, Seleccionaste tres elementos incorrecto de manera seguida. Vamos, intentalo de nuevo';
      vartempo = 1;
    }
