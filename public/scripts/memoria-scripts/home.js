       ...
       if(open_ele[0].style.backgroundImage.split("/")[2] == open_ele[1].style.backgroundImage.split("/")[2])
       {
          ...
          if(total == 18) //if all matches are found
          {
            showModal();
             ...
             eles[eles.length-2].innerHTML="Player 1 : " + mode +" <span style='color : rgb(45,247,55);'>Completado</span>";
             document.getElementsByTagName("table")[0].style.display="none";
             document.getElementsByClassName("message")[0].style.display="block";
             document.getElementsByClassName("message")[0].innerHTML=":) Estamos muy orgulloso de tí. Encontraste todos los elementos!.";
        ...
        else
        {
          ...
          if(attempts == 0)
          {
            ...
            document.getElementsByTagName("table")[0].style.display="none";
            document.getElementsByClassName("message")[0].style.display="block";
            document.getElementsByClassName("message")[0].innerHTML=":( Sigue intentando....Ya no quedan más intentos. Animate.";
            document.getElementsByClassName("message-button")[0].style.display="block";
            open_ele.length=0;
             return;
          }
...
function setBackground()
{
  ...
  for(var i=1;i<=18;i++)
  {
    arr.push("../imgs/memory-easy-imgs/org/"+String(i)+".png");
    arr.push("../imgs/memory-easy-imgs/copy/"+String(i)+".png");
  }
   arr = shuffle(arr);  
...
function setDifficulty(_mode)
{
  ...
  li_1.innerHTML="Jugador 1 : "+ mode +" <span style='color : rgb(227,72,20);'>en marcha</span>";
  li_2.innerHTML="Elementos Encontrados: " + String(total) + " / 18"; 
  ...
  ul.appendChild(document.createElement("br"));
  ul.appendChild(document.createElement("br"));
  document.getElementsByTagName("attempt")[0].innerHTML = "Intentos restantes : " + attempts;
