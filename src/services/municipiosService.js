...
const apiUrl = `${process.env.REACT_APP_API_URL}municipios`;

let municipiosService = {};

municipiosService.getAllMunicipios = async () => {
...
municipiosService.getByProvinciaId = async (provinciaId) => {
  const cancelToken = axios.CancelToken;
  const source = cancelToken.source();
