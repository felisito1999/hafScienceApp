    ...
    <div className="component-wrapper">
      ...
      >
        <h1 id="welcome-banner-title" className="text-center m-0">
          Bienvenido {JSON.parse(localStorage.getItem('userData')).nombres}{' '}
        ...
        <p id="welcome-banner-text" className="pt-5 pb-5">
          ...
          químicos que existen ordenados según sus propiedades físicas. Fue
          diseñada por el químico ruso Dmitri Mendeléiev en 1869 y es
